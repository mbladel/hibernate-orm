...
| `type()` | The (concrete) type name | `type(e)` | &check;
...
The function `type()`, applied to an identification variable, evaluates to the type name of the referenced entity or embeddable.
This is mainly useful when dealing with entity or embeddable inheritance hierarchies.
