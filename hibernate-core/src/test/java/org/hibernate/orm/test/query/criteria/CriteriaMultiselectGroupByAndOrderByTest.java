...
public class CriteriaMultiselectGroupByAndOrderByTest {
	...
	@Test
	@Jira( "https://hibernate.atlassian.net/browse/HHH-17231" )
	@SkipForDialect( dialectClass = SQLServerDialect.class, reason = "The ORDER BY clause is invalid derived tables, used for tuple in-subquery predicate")
	@SkipForDialect( dialectClass = SybaseDialect.class, reason = "An ORDER BY clause is not allowed in a derived table, used for tuple in-subquery predicate")
