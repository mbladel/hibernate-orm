...
@DomainModel( annotatedClasses = {
		EmbeddedIdGeneratedValueOnExecutionTest.SystemUser.class,
		EmbeddedIdGeneratedValueOnExecutionTest.PK.class,
} )
@SessionFactory
@Jira( "https://hibernate.atlassian.net/browse/HHH-9662" )
public class EmbeddedIdGeneratedValueOnExecutionTest {
	@AfterAll
