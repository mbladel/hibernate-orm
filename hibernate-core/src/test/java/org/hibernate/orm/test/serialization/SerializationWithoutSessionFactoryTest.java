 ...
 */
public class SerializationWithoutSessionFactoryTest extends BaseUnitTestCase {
	@Test
	public void testUninitializedProxySerializationWithoutSessionFactory() {
		executeTest( false );
	}

	@Test
	public void testInitializedProxySerializationWithoutSessionFactory() {
		executeTest( true );
	}
