...
import static org.hibernate.orm.test.annotations.inheritance.joined.JoinedSubclassWithDiscriminatorRemovalByTypeTest.BaseEntity;
import static org.hibernate.orm.test.annotations.inheritance.joined.JoinedSubclassWithDiscriminatorRemovalByTypeTest.BaseVehicle;
import static org.hibernate.orm.test.annotations.inheritance.joined.JoinedSubclassWithDiscriminatorRemovalByTypeTest.Car;
import static org.hibernate.orm.test.annotations.inheritance.joined.JoinedSubclassWithDiscriminatorRemovalByTypeTest.Truck;
...
public class JoinedSubclassWithDiscriminatorRemovalByTypeTest {
	...
	@Test
	public void testRemoval(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
		...
		scope.inTransaction(
				session -> {
					...
					session.createMutationQuery( "delete from BaseVehicle e where type(e) in(:type) " )
