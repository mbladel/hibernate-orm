...
@DomainModel( annotatedClasses = {
		InheritedTypeAssociationFetchTest.Animal.class,
		InheritedTypeAssociationFetchTest.Tiger.class,
		InheritedTypeAssociationFetchTest.Elephant.class,
		InheritedTypeAssociationFetchTest.Zoo.class,
} )
@SessionFactory( useCollectingStatementInspector = true )
@Jira( "https://hibernate.atlassian.net/browse/HHH-17328" )
public class InheritedTypeAssociationFetchTest {
	@BeforeAll
