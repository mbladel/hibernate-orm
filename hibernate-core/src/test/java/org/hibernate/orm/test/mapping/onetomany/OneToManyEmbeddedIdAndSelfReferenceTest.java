...
@DomainModel( annotatedClasses = {
		OneToManyEmbeddedIdAndSelfReferenceTest.PkComposite.class,
		OneToManyEmbeddedIdAndSelfReferenceTest.Element.class,
		OneToManyEmbeddedIdAndSelfReferenceTest.Tag.class
} )
@Jira( "https://hibernate.atlassian.net/browse/HHH-16363" )
public class OneToManyEmbeddedIdAndSelfReferenceTest {
	@AfterEach
