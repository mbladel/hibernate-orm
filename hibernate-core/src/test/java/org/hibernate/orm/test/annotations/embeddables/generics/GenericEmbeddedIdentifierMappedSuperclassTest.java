...
@DomainModel( annotatedClasses = {
		...
		GenericEmbeddedIdentifierMappedSuperclassTest.Report.class,
...
public class GenericEmbeddedIdentifierMappedSuperclassTest {
	...
	@MappedSuperclass
	public static class UserAccessReport extends AccessReport<User> {
		@Override
		@EmbeddedId
	...
	public static class UserReport extends UserAccessReport {
	}

	@MappedSuperclass
	public static class GroupAccessReport extends AccessReport<Group> {
		@Override
		@EmbeddedId
		@AssociationOverrides( {
				@AssociationOverride( name = "owner", joinColumns = {
	...
	public static class GroupReport extends GroupAccessReport {
	}
}
