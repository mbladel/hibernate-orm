...
@DomainModel( annotatedClasses = {
		OneToManyInheritanceSubTypeTest.LinkedEntity.class,
		OneToManyInheritanceSubTypeTest.SingleTableEntity.class,
		OneToManyInheritanceSubTypeTest.SingleA.class,
		OneToManyInheritanceSubTypeTest.SubSingleA.class,
		OneToManyInheritanceSubTypeTest.SingleB.class,
		OneToManyInheritanceSubTypeTest.JoinedEntity.class,
		OneToManyInheritanceSubTypeTest.JoinedA.class,
		OneToManyInheritanceSubTypeTest.SubJoinedA.class,
		OneToManyInheritanceSubTypeTest.JoinedB.class,
		OneToManyInheritanceSubTypeTest.UnionEntity.class,
		OneToManyInheritanceSubTypeTest.UnionA.class,
		OneToManyInheritanceSubTypeTest.SubUnionA.class,
		OneToManyInheritanceSubTypeTest.UnionB.class,
} )
@SessionFactory( useCollectingStatementInspector = true )
@Jira( "https://hibernate.atlassian.net/browse/HHH-16616" )
@Jira( "https://hibernate.atlassian.net/browse/HHH-17483" )
public class OneToManyInheritanceSubTypeTest {
	@BeforeAll
