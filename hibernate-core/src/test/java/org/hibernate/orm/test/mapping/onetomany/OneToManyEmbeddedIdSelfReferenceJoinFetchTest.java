...
@DomainModel( annotatedClasses = {
		OneToManyEmbeddedIdSelfReferenceJoinFetchTest.OrganizationId.class,
		OneToManyEmbeddedIdSelfReferenceJoinFetchTest.OrganizationEmbedded.class,
		OneToManyEmbeddedIdSelfReferenceJoinFetchTest.Organization.class
} )
@Jira( "https://hibernate.atlassian.net/browse/HHH-16473" )
public class OneToManyEmbeddedIdSelfReferenceJoinFetchTest {
	@BeforeAll
