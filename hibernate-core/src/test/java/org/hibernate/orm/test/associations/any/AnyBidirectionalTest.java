...
public class AnyBidirectionalTest {
	...
	public void setUp(SessionFactoryScope scope) {
		scope.inTransaction( session -> {
			final PropertyHolder iph = new PropertyHolder( 1L, new IntegerProperty( 1L, "acc_num", 1234 ) );
			final PropertyHolder sph = new PropertyHolder( 2L, new StringProperty( 2L, "acc_name", "daily" ) );
			session.persist( iph );
			session.persist( sph );
		} );
	}
