...
public abstract class CollectionBinder {
	...
	public static void bindCollection(
		...
		collectionBinder.setBatchSize( property.getAnnotationUsage( BatchSize.class ) );
...
//				comment,
	...
	public void setBatchSize(AnnotationUsage<BatchSize> batchSize) {
		this.batchSize = batchSize == null ? -1 : batchSize.getInteger( "size" );
	}
