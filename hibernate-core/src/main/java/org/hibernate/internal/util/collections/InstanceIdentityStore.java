...
public class InstanceIdentityStore<V> extends AbstractPagedArray<Object> {
	...
	/**
	 * Associates the specified value with the specified instance-id and key in this store (optional operation).
	 * If the store previously contained a mapping for the key, the old value is replaced by the specified value.
	 * <p>
	 * The {@code key} is also kept in the store to ensure instance identity ({@code ==}) when retrieving values.
	 *
	 * @param instanceId the instance-id of the key to be stored
	 * @param key key with which the specified value is to be associated
	 * @param value value to be associated with the specified key
	 */
	public void put(int instanceId, Object key, V value) {
		if ( key == null ) {
