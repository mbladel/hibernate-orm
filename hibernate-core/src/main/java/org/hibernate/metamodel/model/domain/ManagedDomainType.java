...
public interface ManagedDomainType<J> extends SqmExpressible<J>, DomainType<J>, ManagedType<J> {
	...
	SingularPersistentAttribute<? super J, ?> findGenericEmbeddableAttribute(String name);
	...
	SingularPersistentAttribute<? super J, ?> findDeclaredGenericEmbeddableAttribute(String name);
