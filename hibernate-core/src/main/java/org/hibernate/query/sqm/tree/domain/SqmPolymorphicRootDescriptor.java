...
public class SqmPolymorphicRootDescriptor<T> implements EntityDomainType<T> {
	...
	@Override
	public SingularPersistentAttribute<? super T, ?> findGenericEmbeddableAttribute(String name) {
		return null;
	}
	...
	@Override
	public SingularPersistentAttribute<? super T, ?> findDeclaredGenericEmbeddableAttribute(String name) {
		return null;
	}
