...
public class SqmPolymorphicRootDescriptor<T> implements EntityDomainType<T> {
	...
	@Override
	public SingularPersistentAttribute<? super T, ?> findConcreteGenericAttribute(String name) {
		return null;
	}
	...
	@Override
	public SingularPersistentAttribute<? super T, ?> findDeclaredConcreteGenericAttribute(String name) {
		return null;
	}
