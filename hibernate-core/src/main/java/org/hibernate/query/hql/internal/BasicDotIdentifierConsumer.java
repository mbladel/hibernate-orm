		...
		public SemanticPathPart resolvePathPart(
			...
			if ( importableName != null ) {
				...
				if ( managedType instanceof EntityDomainType<?> ) {
					...
					// Special entity types, that are not supported by JPA, could still be used here
					final EntityDomainType<?> entity = jpaMetamodel.entity( importableName );
					if ( entity != null ) {
						return new SqmLiteralEntityType<>( entity, nodeBuilder );
					}
				}
			}
