...
public class HibernateCriteriaBuilderDelegate implements HibernateCriteriaBuilder {
	...
	@Override
	public <T extends TemporalAccessor> JpaFunction<T> dateTrunc(Expression<T> datetime, TemporalUnit temporalUnit) {
		return criteriaBuilder.dateTrunc( datetime, temporalUnit );
	}
