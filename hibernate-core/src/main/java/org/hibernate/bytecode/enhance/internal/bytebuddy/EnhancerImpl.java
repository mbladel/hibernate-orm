...
public class EnhancerImpl implements Enhancer {
	...
	private static boolean containsField(Generic type, String fieldName, ByteBuddyEnhancementContext enhancementContext) {
		do {
			if ( type.getDeclaredFields().stream().filter( f -> !Modifier.isStatic( f.getModifiers() ) )
